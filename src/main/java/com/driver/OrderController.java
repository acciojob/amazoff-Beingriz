...
public class OrderController {
    ...
    public ResponseEntity<String> addOrderPartnerPair(@RequestParam String orderId, @RequestParam String partnerId){
        ...
        orderService.pairOrders(orderId, partnerId);
    ...
    public ResponseEntity<Integer> getOrderCountByPartnerId(@PathVariable("partnerId") String partnerId){
        ...
        Integer orderCount = orderService.countOrdersByPartner(partnerId);
    ...
    public ResponseEntity<List<String>> getOrdersByPartnerId(@PathVariable("partnerId") String partnerId){
        List<String> orders = orderService.listOfOrderByPartnerId(partnerId);
    ...
    public ResponseEntity<Integer> getCountOfUnassignedOrders(){
        Integer countOfOrders = orderService.unAssignedOrders();
